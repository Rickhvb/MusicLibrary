...
<html>
    ...
    <body id="fundo">
        ...
        <div class="row">
            ...
            <? endif; ?>
                <form action="ListaArtistasLogado.php?acao=removerArtista" method="post">
                <h1 for="login" class="titulo">Confirmação de exclusão do Artista/Banda </h1>
                <h4 for="login" class="frm">Isso removerá inclusive os respectivos álbuns e músicas </h4>
                ...
                <br>
                    ...
                    <br><br>
                    <div><a  class="btn btn-primary btn-lg btn-default" href="ListaArtistasLogado.php">Voltar</a></div>
                </form>
            </div>
